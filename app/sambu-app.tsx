...
export default function SambuApp({user}:{user:User}) {
  ...
  return <div className="app-shell beta-app">
    ...
    {user?.temporaryAdmin&&<div className="beta-banner" role="status">Teste temporário sem login · importação de livros liberada · biblioteca e progresso compartilhados entre os visitantes.</div>}
