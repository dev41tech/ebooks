...
export default function PilotPreparation(){
 ...
 return <section className="beta-report"><h3>Preparar o piloto</h3><p>Planeje um mês de teste. Comece com 3 leitores e, após conferir cadastro, leitura e retomada no celular, amplie para até 20 participantes.</p><ol><li>Escolha 5 livros revisados e confira suas autorizações de distribuição.</li><li>Baixe uma cópia dos dados e arquivos antes do início. Evite editar ou importar livros durante a cópia.</li><li>Compartilhe o link e o <a href="/?view=guide">guia para leitores</a> apenas com o grupo escolhido. O link atual não bloqueia o acesso por e-mail.</li></ol><button className="outline" disabled={busy} onClick={async()=>{
