/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --config .sites-runtime/typegen.json --include-runtime` (hash: ac8ea62b8903ac19904cba69d6d26c5b)
// Runtime types generated with workerd@1.20260515.1 2026-09-01 nodejs_compat
interface __BaseEnv_Env {
	BUCKET: R2Bucket;
	DB: D1Database;
	SAMBU_AUTH_MODE: "sites";
	SAMBU_ADMIN_EMAILS: "";
	SAMBU_BETA_EMAILS: "";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SAMBU_AUTH_MODE" | "SAMBU_ADMIN_EMAILS" | "SAMBU_BETA_EMAILS">> {}
}
