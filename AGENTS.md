...
- Este projeto é o ambiente separado Sambu R3 Testes. Preservar seu project_id. O usuário autorizou o beta público, com leitura para contas autenticadas e administração de testes limitada aos e-mails em SAMBU_ADMIN_TESTER_EMAILS. Não liberar administração indiscriminadamente; a senha master do proprietário permanece protegida. O domínio ebooks.41tech.cloud é outro ambiente e não deve ser alterado por suposição.
